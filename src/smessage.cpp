...
// Copyright (c) 2015 The MazeCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("mazecoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("mazecoin-smsg-pow"); // Make this thread recognisable
